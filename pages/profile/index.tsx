    ...
    <div className="px-4">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col">
          <div className="flex">
            <span className="text-lg font-medium">Steve Jobs</span>
            <span className="text-sm italic text-gray-400 py-1 px-3">School Name</span>
          </div>
      ...
      <div className="mt-10 flex justify-around">
        <Link href="/profile/sold" className="flex flex-col items-center">
          ...
          <span className="mt-2 text-sm font-medium">Sold</span>
        </Link>
        <Link href="/profile/bought" className="flex flex-col items-center">
          ...
          <span className="mt-2 text-sm font-medium">Bought</span>
        </Link>
        <Link href="/profile/loved" className="flex flex-col items-center">
          ...
          <span className="mt-2 text-sm font-medium">Loved</span>
        </Link>
      </div>
      <div className="mt-12">
